...
import com.example.ssgmemo.databinding.ActivityViewCtrgBinding

class ViewCtrgActivity : AppCompatActivity() {
    private lateinit var binding: ActivityViewCtrgBinding
    val helper = SqliteHelper(this, "ssgMemo", 1)

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityViewCtrgBinding.inflate(layoutInflater)
